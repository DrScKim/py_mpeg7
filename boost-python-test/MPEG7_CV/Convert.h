...
public:
	...
	static void setShape( Mat& mask, MomVop* img, int val, int fval = 255, cv::Rect* roi = 0 );
	static void setShape( Mat& mask, MomVop* img, int val, int bval = 0, int fval = 255, cv::Rect* roi = 0 );
